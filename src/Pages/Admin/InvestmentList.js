    ...
    const fetchInvestments = async () => {
      try {
        const config = {
          ...
          url: "https://api.sentryvest.com/v1/api/investment_list",
          headers: {
            "x-api-key": "30072024",
          },
        };
              ...
              <table className="w-full shadow-title">
                ...
                <thead className="flex flex-row items-start bg-buttonColor/10 h-12">
                  <tr className="flex justify-between items-center font-gotham w-full text-sm h-full text-homeColor">
                    ...
                    <th className="flex justify-start w-32 px-6">Amount</th>
                  ...
                  {investments
                    ...
                    .map((investment, index) => (
                      ...
                      >
                        ...
                        <td className="flex justify-start w-32 px-6">
                          {investment.amount}
                        </td>
                        ...
                        <td className="flex justify-start text-buttonColor w-32 px-6">
                          <Link
                            to={`/adminaccess/investment/${investment.id}`}
